...
#### Fetch the docker image:
 ```
 docker pull mjherrma/ib-gateway-service:3.0.5
```
#### Start the service:
```
docker run -p 5050:5050 -p 5000:5000 mjherrma/ib-gateway-service:3.0.5
```
...
```bash
docker run -it --entrypoint npm mjherrma/ib-gateway-service:3.0.5 run setup-ibkey
```
